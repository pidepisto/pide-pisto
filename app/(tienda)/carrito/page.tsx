...
export default function CarritoPage() {
  ...
  if (items.length === 0) {
    return (
      ...
      >
        ...
        >
          <ShoppingCart className="h-9 w-9" style={{ color: 'oklch(0.50 0.22 24)' }} />
        </div>
        <div className="text-center">
          <h1
            style={{ fontFamily: 'var(--font-bebas)', fontSize: '2rem', letterSpacing: '0.04em', color: 'oklch(0.50 0.22 24)' }}
          >
  ...
  return (
    <div style={{ backgroundColor: 'oklch(0.97 0.012 82)', minHeight: '100vh' }}>
      ...
      {/* Header */}
      <div
        className="sticky top-14 z-30 px-4 py-4 border-b flex items-center justify-between"
      ...
      >
        ...
        <button
          onClick={limpiar}
          className="text-xs font-medium flex items-center gap-1 px-3 py-1.5 rounded-xl hover:bg-black/5 transition-colors"
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 flex flex-col gap-4 pb-40">
        ...
        {items.map(({ producto, cantidad }) => (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p
                className="mt-0.5"
                style={{ fontFamily: 'var(--font-bebas)', fontSize: '1.1rem', letterSpacing: '0.03em', color: 'oklch(0.50 0.22 24)' }}
              >
                ${(producto.precio * cantidad).toFixed(0)}
              </p>
              {cantidad > 1 && (
                <p className="text-xs" style={{ color: 'oklch(0.60 0.02 40)', fontFamily: 'var(--font-dm-sans)' }}>
                  ${producto.precio.toFixed(0)} c/u
                </p>
              )}
            </div>
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              ...
              >
                {cantidad === 1 ? <Trash2 className="h-3.5 w-3.5" style={{ color: 'oklch(0.65 0.15 24)' }} /> : <Minus className="h-3.5 w-3.5" />}
              </button>
              ...
              <button
                ...
                style={{
                  backgroundColor: cantidad >= producto.stock ? 'oklch(0.92 0.02 82)' : 'oklch(0.50 0.22 24)',
        ...
        >
          ...
          <div className="flex flex-col gap-2">
            {items.map(({ producto, cantidad }) => (
              <div key={producto.id} className="flex justify-between text-sm" style={{ fontFamily: 'var(--font-dm-sans)' }}>
                ...
                <span style={{ color: 'oklch(0.2 0.03 30)', fontWeight: 500 }}>${(producto.precio * cantidad).toFixed(0)}</span>
              </div>
            ))}
          </div>
          ...
          <div className="flex justify-between items-center">
            ...
            <span style={{ fontFamily: 'var(--font-bebas)', fontSize: '1.6rem', letterSpacing: '0.03em', color: 'oklch(0.50 0.22 24)' }}>
              ${total().toFixed(0)}
            </span>
          </div>
        </div>
        ...
        <div className="max-w-2xl mx-auto">
          <Link href="/checkout">
            ...
            >
              Ir a checkout
              <span
                className="ml-auto px-2 py-0.5 rounded-lg text-sm font-bold"
